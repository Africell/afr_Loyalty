...
func (UC *UserControl) Add_LoyaltyServiceRoutes(R *Routes) {
	...
	*R = append(*R, r)
	...
	Level1 = "Customer Loyalty - Get Next Level"
	Level1DisplayOrder = Level1DisplayOrder + 1
	r = Route{
		"HTTP_Customer_Loyalty_Account_GetNextLevel",
		"GET",
		"/" + Configuration.LoyaltyModule + "/" + Configuration.LoyaltyVersion + "/HTTP_Customer_Loyalty_Account_GetNextLevel/",
		Use(UC.HTTP_Customer_Loyalty_Account_GetNextLevel, UC.ValidateAccess_AUC, UC.ValidateJWEToken),
		true,
		Level1 + "",        // DisplayName
		DisplayOrder,       // DisplayOrder
		Module,             // Module
